...
Party values the ability of individual legislators to cultivate a personal vote in swing SMDs, which is effectively a sort of insurance policy against changing electoral fates in swing SMDs and is willing to sacrifice party unity to renew the insurance policy.

Party values the ability of individual legislators to
